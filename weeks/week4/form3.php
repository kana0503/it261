...
// our second if statement - if I have empty fields, that is not good, I will echo "please fill our all of the fields!!!! Now, if the fields are not empty, then my else eill display an echo of the information"
