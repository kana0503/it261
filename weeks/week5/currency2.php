...
<head>
    ...
    <title>Currency 2 form with drop dwon</title>
...
<!--- time for our radio button that has an additional attribute of value --->
    ...
    <select name="bank">
        ...
        <option value ="becu">Boeing Credit</option>
    </select>
...
if($_SERVER['REQUEST_METHOD'] =='POST') {
    ...
    if (isset($_POST['name'], $_POST['email'], $_POST['amount'], $_POST['currency'], $_POST['bank'])){
        ...
        <div class="box">
        <h2>Hello  '.$name.'</h2>
        <p>You now have <b>$'.floor($dollars).' American dollars</b> and we will be emailing you at <b>'.$email.'</b> with your information, as well as depositiong your funds at <b>'.$bank.' bank</b> !</p>
        </div>        
        ';
    }
}
